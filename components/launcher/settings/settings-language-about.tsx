...
import { IconCheck, IconBrandDiscord, IconWorld, IconInfoCircle, IconLanguage, IconRotate } from "@tabler/icons-react"
    ...
    <div className="space-y-8 animate-in fade-in-0 slide-in-from-left-4 duration-300">
      <section className="text-center py-8">
        <div className="w-20 h-20 rounded-2xl bg-primary/20 flex items-center justify-center mx-auto mb-4">
          <img src="./spot-logo-mono-2.png" alt="Spot" className="w-12 h-12 object-contain" draggable={false} />
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <a href="https://spotmc.ru" target="_blank" rel="noopener noreferrer"
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-foreground/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
              <IconWorld className="w-6 h-6 text-foreground" strokeWidth={1.5} />
            </div>
            <div>
              <div className="font-medium text-foreground">SpotMC</div>
              <div className="text-sm text-muted-foreground">{t("settings.about.source")}</div>
            </div>
          </a>
          <a href="https://discord.gg/ukz9kYVM9B" target="_blank" rel="noopener noreferrer"
        ...
        <div className="p-4 rounded-xl border border-border bg-muted/30 space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-foreground flex items-center gap-2">
              <img src="./spot-logo-mono-2.png" alt="" className="w-6 h-6 object-contain rounded" />
              calon4k
            </span>
          </div>
