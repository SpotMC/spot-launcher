...
export const ONBOARDING_COPY: Record<OnboardingLanguage, OnboardingCopy> = {
  ru: {
    steps: [
      ...
      { title: "Моды", description: "Выбери моды, которые будут установлены." },
    ...
    accountModeOfflineDesc: "Играй без учётки — на серверах без проверки лицензии.",
  ...
  en: {
    steps: [
      ...
      { title: "Mods", description: "Choose the mods to install." },
    ...
    accountModeOfflineDesc: "Play without an account on servers without license check.",
  ...
  uk: {
    steps: [
      ...
      { title: "Моди", description: "Обери моди, які будуть встановлені." },
    ...
    accountModeOfflineDesc: "Грай без акаунта — на серверах без перевірки ліцензії.",
  ...
  de: {
    steps: [
      ...
      { title: "Mods", description: "Wähle die zu installierenden Mods." },
    ...
    accountModeOfflineDesc: "Spiele ohne Konto auf Servern ohne Lizenzprüfung.",
    accountNicknameLabel: "Nickname",
  ...
  es: {
    steps: [
      ...
      { title: "Mods", description: "Elige los mods que se instalarán." },
    ...
    accountModeOfflineDesc: "Juega sin cuenta en servidores sin comprobación de licencia.",
