        ...
        <div className="flex-1 relative overflow-hidden rounded-2xl bg-card border border-border flex flex-col items-center justify-center gap-6">
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-4">
            ...
            <button onClick={() => setShowAuth(true)}
              className="mt-6 px-8 py-3 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-semibold transition-allactive:scale-[0.98]">
            ...
            <div className="flex items-center gap-2">
              {isConnecting ? (
                ...
                <button onClick={handleRetry}
                  className="px-4 py-2 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-semibold transition-all">
                  {t("network.connect")}
                </button>
              )}
            </div>
      ...
      <div className="relative overflow-hidden rounded-2xl bg-card border border-border flex-1 min-h-0 flex flex-col">
        ...
        <div className="px-5 py-4 border-t border-border/50 shrink-0 flex gap-3">
          <button onClick={() => { setShowCreate(true); setFormError(""); setFormName(""); setFormPassword("") }}
            className="flex-1 flex items-center justify-center gap-2.5 py-3 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground text-sm font-semibold transition-allactive:scale-[0.98]">
