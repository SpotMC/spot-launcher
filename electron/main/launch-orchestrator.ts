      ...
      worker.on("message", (raw: unknown) => {
        ...
        switch (payload.type) {
          ...
          case "started":
            ...
            // Статистика: отправить 'join' и запустить heartbeat.
            void startStatsSession(launchAccount, {
              quickPlayMultiplayer: request.quickPlayMultiplayer,
          ...
          case "close":
            ...
            // Статистика: остановить heartbeat и отправить 'leave'.
            void stopStatsSession(true)
            if (request.buildName) {
